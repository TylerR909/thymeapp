...
- **`docs/TOOLING.md`** — stack and layout
- **`packages/mobile/src/SCREENS.md`** — screen-level feature specs
- **`docs/references/README.md`** — how ThymeApp combines Swarm + Lifecycle
- **`docs/references/swarm.md`** — Foursquare Swarm product bible (check-ins, stickers, mayorships, coins)
- **`docs/references/lifecycle.md`** — Life Cycle product bible (passive tracking, donut recaps, place slices)
